...
export const i18n = {
  EN: {
    ...
    variants: 'variants',
    randomTest: 'Random Questions',
    randomTestDesc: '40 random questions from all variants',
    nextQ: 'Next Question →',
    ...
    timerOff: 'Off',
    timerOn: '20s',
    autoConfirmSetting: 'Answer Mode',
    autoConfirmOn: 'Auto',
    autoConfirmOff: 'Button',
  ...
  RU: {
    ...
    variants: 'вариантов',
    randomTest: 'Случайные вопросы',
    randomTestDesc: '40 случайных вопроса из всех вариантов',
    ...
    timerOn: '20 секунд',
    autoConfirmSetting: 'Режим ответа',
    autoConfirmOn: 'Авто',
    autoConfirmOff: 'Кнопка',
  ...
  KZ: {
    ...
    variants: 'нұсқа',
    randomTest: 'Кездейсоқ сұрақтар',
    randomTestDesc: 'Барлық нұсқалардан 40 кездейсоқ сұрақ',
    nextQ: 'Келесі сұрақ →',
    ...
    timerOff: 'Таймерсіз',
    timerOn: '20 секунд',
    autoConfirmSetting: 'Жауап режимі',
    autoConfirmOn: 'Авто',
    autoConfirmOff: 'Батырма',
