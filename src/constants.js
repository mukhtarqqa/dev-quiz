...
export const i18n = {
  EN: {
    ...
    randomTestDesc: 'One random question from each variant',
    nextQ: 'Next Question →',
  ...
  RU: {
    ...
    randomTestDesc: 'По одному случайному вопросу из каждого варианта',
  ...
  KZ: {
    ...
    randomTestDesc: 'Әр нұсқадан бір кездейсоқ сұрақ',
    nextQ: 'Келесі сұрақ →',
