  ...
  web_ru: {
    variant1: [
      ...
      },
      {
        ...
        options: [
          "<div><p>link</p></div> используется для простых текстовых ссылок",
          "<span><a></a></span> используется только для inline-элементов",
          "<section><img></section> используется для графических элементов",
          "<header><div></div></header> используется как общий контейнер",
          "<nav><ul><li><a></a></li></ul></nav> является правильной структурой для навигации",
        ],
        correct: 4,
      },
      {
    ...
    variant3: [
      {
        q: "Выберите вариант, правильно описывающий основное различие между innerText и innerHTML:",
        options: [
          "Свойство innerText предназначено для управления CSS-стилями и не связано с HTML-структурой",
          "Свойство innerHTML полностью считывает HTML-код внутри элемента и позволяет его изменять",
          "innerText и innerHTML работают одинаково и не имеют различий",
          "innerHTML обрабатывает только простой текст и игнорирует HTML-теги",
          "innerText полностью обрабатывает HTML-структуру и интерпретирует теги",
        ],
        correct: 1,
      },
      {
        q: "Определите основную цель метода setAttribute:",
        options: [
          "Используется для добавления нового атрибута к HTML-элементу или изменения значения существующего",
          "Применяется как функция для динамического изменения CSS-стилей",
          "Является механизмом для хранения переменных JavaScript",
      ...
      },
      {
        ...
        options: [
          "Возвращает полный DOM-объект со всеми свойствами элемента",
          "Возвращает значение указанного атрибута в виде строки (string)",
          "Возвращает текущие значения CSS-стилей",
          "Возвращает JavaScript-функцию",
          "Возвращает массив значений",
        ],
        correct: 1,
      },
      {
        q: "Определите функцию метода createElement():",
        options: [
          "Используется для объявления новой переменной в JavaScript",
          "Применяется для полного удаления элементов из HTML-документа",
          "Позволяет динамически создавать новый HTML-элемент в DOM",
          "Автоматически генерирует CSS-файлы",
          "Используется для отправки запросов к внешним API",
        ],
        correct: 2,
      },
      {
        ...
        options: [
          "Изменяет стиль элемента и добавляет новые CSS-свойства",
          "Добавляет новый DOM-элемент в конец выбранного элемента",
          "Объединяет переменные и создает новое значение",
          "Вызывает определенную функцию",
      ...
      {
        q: "Определите функцию атрибута required:",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          "Проверяет введенное значение с помощью регулярного выражения",
      ...
      {
        q: "Выберите правильный способ регистрации события в JavaScript:",
        options: [
          "Метод addClick() является основным способом управления событиями",
      ...
      {
        q: "Определите характеристику события keydown:",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          "Ранее сохраненное значение в виде строки (string)",
          "Значения CSS",
          "DOM-объект",
          "Функцию",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Удаляет все сохраненные данные в браузере",
          "Изменяет CSS-стили",
          "Перестраивает DOM",
          "Добавляет API",
        ],
      ...
      {
        q: "Правильно опишите разницу между null и undefined:",
        options: [
          "undefined — переменной не присвоено значение, а null — намеренно заданное пустое значение",
      ...
      {
        q: "Определите, что не является циклом:",
        options: [
      ...
      {
        q: "Какова функция метода filter():",
        options: [
          "Возвращает одно значение",
          "Создает новый массив с элементами, удовлетворяющими условию",
          "Устанавливает CSS-свойства",
      ...
      {
        q: "Какова функция метода setTimeout:",
        options: [
          "Выполняет API-запрос",
      ...
      {
        q: "Какова функция метода clearInterval:",
        options: [
          "Создает DOM",
      ...
      {
        q: "Определите разницу между NodeList и Array:",
        options: [
      ...
      {
        q: "Какова функция метода stopPropagation():",
        options: [
          "Изменяет HTML",
      ...
      },
      {
        ...
        options: [
          "Для отмены стандартного поведения элемента (действия по умолчанию)",
          "Для остановки всплытия события (event bubbling)",
          "Для удаления элемента из DOM-дерева",
          "Для изменения CSS-стилей элемента",
          "Для создания нового пользовательского события",
        ],
        correct: 0,
      },
    ],
    variant4: [
      {
        q: "Определите основную функцию метода closest():",
        options: [
      ...
      },
      {
        ...
        options: [
          ...
          "Передает данные через body",
          "Работает только с JSON",
          "Передает данные через CSS",
          "Отключает API",
        ],
        correct: 0,
      },
    ...
    variant5: [
      {
        q: "Выберите вариант, правильно описывающий семантическую структуру HTML-документа:",
        options: [
      ...
      {
        q: "Разница между controlled и uncontrolled компонентами:",
      ...
      {
        q: "Throttling vs Debouncing:",
        options: ["CSS", "HTML", "Управление частотой вызовов", "API", "DOM"],
        correct: 2,
      },
      {
      ...
      },
      {
        ...
        options: [
          "CSS",
          "HTML",
          "Обертка без дополнительного DOM-элемента",
          "API",
          "DOM",
        ],
        correct: 2,
      ...
      {
        q: "Lazy loading:",
        options: ["CSS", "HTML", "Повышение производительности", "API", "DOM"],
        correct: 2,
      },
      {
        q: "Преимущество CDN:",
      ...
      },
      {
        ...
        options: ["CSS", "HTML", "Не блокирует основной поток", "API", "DOM"],
        correct: 2,
      },
    ],
    variant6: [
      ...
      {
        q: "Что такое DOM?",
        options: ["CSS", "HTML", "Модель структуры документа", "API", "JSON"],
        correct: 2,
      },
      {
      ...
      {
        q: "В чем отличие sessionStorage?",
        options: [
          "Хранится навсегда",
      ...
      },
      {
        ...
        options: ["Новый массив", "undefined", "object", "number", "string"],
        correct: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Один раз", "Выполняется повторно", "Удаляет", "API", "DOM"],
        correct: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Удаляет", "Сохраняет изменения", "Добавляет", "API", "DOM"],
        correct: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Удаляет", "Получает изменения", "Добавляет", "API", "DOM"],
        correct: 1,
      },
      {
    ...
    variant7: [
      ...
      },
      {
        ...
        options: ["CSS", "HTML", "Адаптация под разные экраны", "API", "DOM"],
        correct: 2,
      },
      {
      ...
      },
      {
        ...
        options: ["Удаляет", "Создает копию", "Добавляет", "API", "DOM"],
        correct: 1,
      },
      {
        q: "Что показывает Git status?",
        options: ["Историю", "Состояние изменений", "Удаление", "API", "DOM"],
        correct: 1,
      },
      {
        q: "Что делает Git log?",
        options: ["Удаляет", "Показывает историю", "Добавляет", "API", "DOM"],
        correct: 1,
      },
      {
        q: "Что делает Git checkout (branch)?",
        options: ["Удаляет", "Переключает ветку", "Добавляет", "API", "DOM"],
        correct: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Число", "Бесконечное значение", "String", "Object", "Array"],
        correct: 1,
      },
      {
        q: "Что делает Number()?",
      ...
      },
      {
        ...
        options: ["Integer", "Случайное число", "String", "Object", "Array"],
        correct: 1,
      },
      {
